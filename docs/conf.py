#!/usr/bin/env python
#
# timelink documentation build configuration file, created by
...
version = timelink.__version__
# The full version, including alpha/beta/rc tags.
release = timelink.__version__
...
latex_documents = [
    (master_doc, 'timelink.tex',
     'Timelink Python package Documentation',
     'Joaquim Ramos de Carvalho', 'manual'),
]
