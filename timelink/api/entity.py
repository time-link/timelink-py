...
# currently finished https://sqlmodel.tiangolo.com/tutorial/limit-and-offset/
class Entity(SQLModel, table=True):
    ...
    the_class: Optional[str] = Field(index=True)
...
def create_root_entity():
    ...
    object = Entity(id="object", description="Object", the_class='class',inside="*ROOT*")
...
def select_entities():
    with Session(engine) as session:
        ...
        statement = select(Entity).where(Entity.the_class == 'class').offset(3).limit(3)
