...
class KElement:
    ...
    An Element can have three possible "aspects":
    ...
    Example in Kleio notation::
         ...
         person$Joaquim Carvalho%Joachim Carvº#Family name added in the margin/id=p-jrc
    ...
    def to_kleio(self, name=True, force_show=False):
        ...
        :param name:  if prefix value with self.name=
        :param force_show: if True render element even if it inherits from
                            invisible\_ # noqa: W605
        :return: a valid Kleio representation of this element

        To avoid rendering the element name set name=False
        If the current element extends the element invisible\_ #noqa: W605
